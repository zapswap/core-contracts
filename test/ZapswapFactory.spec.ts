...
describe('ZapswapFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as ZapswapFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('ZapswapPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('ZapswapPool')
